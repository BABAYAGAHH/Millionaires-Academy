...
const valueCards = [
  ...
  { label: 'Product and category organization', icon: Workflow },
  { label: 'Mobile responsive shopping experience', icon: Smartphone },
...
const fitItems = [
  ...
  'Women launching a business that needs a polished and professional storefront',
...
const shopifyFaqs = faqs.filter(
  (item) => item.category === 'shopify' || item.category === 'general',
)

export const ShopifyWebsite = () => {
  usePageTitle('Shopify Website | Millionaires Academy')
    ...
    <>
      <AnimatedSection className="pt-10 sm:pt-14">
        <Container>
          <div className="luxury-gradient rounded-[2rem] px-8 py-12 text-warmWhite shadow-premium lg:px-10 lg:py-16">
            <SectionHeader
              description="Launch a polished online store that reflects your brand, organizes your products clearly, and gives customers a professional shopping experience."
              eyebrow="Shopify Website"
              tone="inverse"
              title="Premium Shopify Websites for Serious Business Owners"
            />
            <div className="mt-8">
              <Button href="/contact" variant="secondary">
                Apply for Shopify Support
              </Button>
            </div>
          </div>
        </Container>
      ...
      <AnimatedSection className="pt-24">
        <Container>
          <SectionHeader
            centered
            description="Every part of the Shopify support offer is designed to make your storefront feel cleaner, more strategic, and more ready to convert."
      ...
      <AnimatedSection className="pt-24">
        <Container>
          <SectionHeader
            centered
            description="The process is intentionally structured so you can move from creative ideas to a more organized storefront with less guesswork."
            eyebrow="Process"
            title="How the Shopify process works."
          />
      ...
      <FAQSection
        description="Helpful answers for founders thinking about Shopify support, launch timing, and what the process includes."
        items={shopifyFaqs}
        title="Shopify support FAQs"
      />
        ...
        <Container>
          <div className="rounded-[2rem] border border-neutralBorder bg-white p-8 text-center shadow-soft lg:p-10">
            <h2 className="text-balance text-3xl font-semibold text-softBlack sm:text-4xl">
              Ready for a more premium store experience?
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-base leading-8 text-muted">
              Apply for support if you want a more structured, strategic Shopify
              launch with elevated presentation and clearer customer flow.
            </p>
