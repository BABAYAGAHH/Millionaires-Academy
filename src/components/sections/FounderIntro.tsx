  ...
  <AnimatedSection className="pt-24">
    <Container>
      <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        ...
        <div>
          <SectionHeader
            description="Millionaires Academy was created to help ambitious entrepreneurs stop guessing and start building with structure. Through business mentorship, vendor resources, Shopify support, and practical launch blueprints, the platform helps women and aspiring business owners move from idea to execution with clarity and confidence."
